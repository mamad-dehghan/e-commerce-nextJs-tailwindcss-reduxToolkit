                ...
                <div className='flex flex-row gap-4 py-4 px-6  border-y border-y-weef-black'>
                    ...
                    <div className='flex flex-col items-center justify-start w-1/5 text-weef-white'>
                        ...
                        <div className='flex items-center justify-center gap-4'>
                            <Link href='#'><Facebook  className='cursor-pointer'/></Link>
                            <Link href='#'><Twitter  className='cursor-pointer'/></Link>
                            <Link href='#'><Linkedin  className='cursor-pointer'/></Link>
                            <Link href='#'><Instagram  className='cursor-pointer'/></Link>
                        </div>
                    </div>
